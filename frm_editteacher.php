...
<?php
 ...
 ?>
  <tr>
    <td><form action="editteacher.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
      <p>&nbsp;</p>
      <table width="450" border="1" align="center" cellpadding="5" cellspacing="0">
        ...
        <tr>
          ...
          <td width="280"><input name="t_username" type="text" id="t_username" value="<?php echo "$rs[t_username]"; ?>" readonly="readonly" />
            <input name="t_id" type="hidden" id="t_id" value="<?php echo "$rs[t_id]"; ?>" />
            <input name="t_pic" type="hidden" id="t_pic" value="<?php echo "$rs[t_pic]"; ?>" /></td>
        </tr>
        <tr>
          <td>Password</td>
