...
<?php
 ...
 ?>
  <tr>
    <td><form id="form1" name="form1" method="post" action="editposition.php">
      <p>&nbsp;</p>
      <table width="430" height="119" border="1" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="2" align="center">แก้ไขตำแหน่ง</td>
          </tr>
        <tr>
          <td width="142">ชื่อตำแหน่ง</td>
          <td width="282">
          <input type="text" name="po_name" id="po_name" 
          value="<?php echo "$rs[po_name]";?>" />
