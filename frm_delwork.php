...
<?php
 ...
 ?>
  <tr>
    <td align="center" bordercolor="#F1A241"><form id="form1" name="form1" method="post" action="delwork.php">
      <p>&nbsp;</p>
      <table width="430" border="1" cellspacing="0" cellpadding="3">
          <tr>
            <td colspan="2" align="center">ลบผลงาน</td>
          </tr>
          <tr>
            <td width="135">ชื่อผลงาน</td>
            <td width="277">
            <input name="w_name" type="text" id="w_name" 
            value="<?php echo "$rs[w_name]";?>" readonly="readonly"/>
          ...
          <tr>
            <td>ปีที่ได้รับ</td>
            <td>
            <input name="w_year" type="text" id="w_year"
            value="<?php echo "$rs[w_year]";?>" readonly="readonly"/>
            <input name="w_id" type="hidden" id="w_id" 
          ...
          <tr>
            ...
            <td>
            <input name="w_org" type="text" id="w_org" 
            value="<?php echo "$rs[w_org]";?>" readonly="readonly"/>
            <input name="w_id" type="hidden" id="w_id" 
            value="<?php echo "$rs[w_id]";?>"/>
          </tr>
          <tr>
