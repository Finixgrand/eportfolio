...
?>
  <tr>
    <td><form id="form1" name="form1" method="post" action="editdept.php">
      <p>&nbsp;</p>
      <table width="450" border="1" align="center" cellpadding="5" cellspacing="0">
        <tr>
          <td colspan="2" align="center">แก้ไขกลุ่มสาระ</td>
          </tr>
        <tr>
          <td>ชื่อกลุ่มสาระ</td>
          <td><input name="d_name" type= "text" id="d_name" value="<?php echo "$rs[d_name]"; ?>"/> 
