...
<?php
 ...
 ?>
  <tr>
    <td><form id="form1" name="form1" method="post" action="addparent.php">
      <p>&nbsp;</p>
      <table width="450" border="1" align="center" cellpadding="5" cellspacing="0">
		...
		<tr>
          ...
          <td><input type="text" name="pa_id" id="pa_id" /></td>
        </tr> 
        <tr>
          <td>ชื่อ - สกุล</td>
          <td><input type="text" name="pa_name" id="pa_name" /></td>
        </tr>
        <tr>
          <td>อาชีพ</td>
          <td><input type="text" name="pa_occupation" id="pa_occupation" /></td>
        </tr>
        <tr>
          <td>เบอร์โทร</td>
          <td><input type="text" name="pa_tel" id="pa_tel" /></td>
        </tr>
        <tr>
