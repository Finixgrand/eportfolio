...
?>
  <tr>
    <td align="center"><p>&nbsp;</p>
      <form action="index - Copy.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
        <table width="450" border="0" align="center" cellpadding="3" cellspacing="0">
          <tr>
            <td width="95">ชื่ออาจารย์            </td>
            <td width="271"><select name="txt_search" size="1" id="txt_search">
	...
	while($rs2 = mysqli_fetch_array($result2)){
		...
		if("$txt_search" == "$rs2[d_id]") {echo 'selected';}
		echo ">$rs2[d_name]";
		echo "</option>\n";
		}
?>
